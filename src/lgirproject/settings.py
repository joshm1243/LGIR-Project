"""
Django settings for lgirproject project.
...
SECRET_KEY = 'k6lnun*f7sg6(6f1qxha+1@5x=j0&$2_l3%t*bp)&3$1i4_1p*'
...
STATIC_ROOT = os.path.join(str(BASE_DIR), "static", "root")
